...
import { MarkdownStyles, RainbowType, LineBreak } from './styled';
...
class Post extends Component {
  ...
  You don't need to create a web app. Try building small design components with multiple states, slimmed down design systems, or simple data visualizations.
        ...
        <LineBreak />
        <RainbowType>
          <Heading textAlign="center" fontSize="2rem" mb={3} className="colorChange">Learn how to use React for design work</Heading>
        </RainbowType>
        <Text align="center">I'm going to be creating some resources to help designers learn the parts of react that are relevant for their work. If you're interested in using react for your design work you should follow along.</Text>
