...
import { MarkdownStyles, RainbowType, LineBreak, RainbowBreak } from './styled';
...
The actual React API isn't that long, and it shouldn't take more the 2 hours to read it all. Read it once, all the way through. Don't worry if you don't understand what everything means. It's good to have a high level overview of what react is doing and what types of things are in the library.          `}
        ...
        <Text textAlign={["left", "center"]}>I'm going to be creating some resources to help designers learn the parts of react that are relevant for them. If you're interested in using react for your design work you should follow along.</Text>
      </Box>
    );
  }
